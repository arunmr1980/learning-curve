 ...
 * null
 */
package com.gc.petstore.model.transform;
...
public class GetPetRequestProtocolMarshaller implements Marshaller<Request<GetPetRequest>, GetPetRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.API_GATEWAY).requestUri("/dev/pets/{petId}")
