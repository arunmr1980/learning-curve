...
import com.gc.petstore.model.*;
import com.gc.petstore.model.transform.*;
...
class petstoreClient implements petstore {
    ...
    private static final com.amazonaws.opensdk.protect.protocol.ApiGatewayProtocolFactoryImpl protocolFactory = new com.amazonaws.opensdk.protect.protocol.ApiGatewayProtocolFactoryImpl(
            new JsonClientMetadata().withProtocolVersion("1.1").withSupportsCbor(false).withSupportsIon(false).withContentTypeOverride("application/json")
                    .withBaseServiceExceptionClass(com.gc.petstore.model.petstoreException.class));
     ...
     * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/bl8u6h465k-2020-11-14T10:31:13Z/CreatePet" target="_top">AWS
     *      API Documentation</a>
     */
    @Override
     ...
     * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/bl8u6h465k-2020-11-14T10:31:13Z/GetApiRoot"
     ...
     * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/bl8u6h465k-2020-11-14T10:31:13Z/GetPet" target="_top">AWS
     *      API Documentation</a>
     */
    @Override
     ...
     * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/bl8u6h465k-2020-11-14T10:31:13Z/GetPets" target="_top">AWS
     *      API Documentation</a>
     */
    @Override
